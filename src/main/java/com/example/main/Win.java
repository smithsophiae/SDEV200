//Win.java displays win screen and changes to title screen when play again is clicked
...
public class Win {
    ...
    public Scene createWinScreen(Stage primaryStage) {
        ...
        Image winBackgroundImage = null;
        try {
            winBackgroundImage = new Image(getClass().getResource("/images/win10.jpg").toExternalForm());
        } catch (Exception e) {
            System.out.println("⚠ ERROR: Win background image not found!");
        }
